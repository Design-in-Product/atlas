...
function playAnimation() {
  ...
  // While a morph is in progress, freeze the year counter so the animation
  // has time to play out fully before we advance to the next keyframe.
  if (!isTransitioning) {
    ...
    // Update other layers for current year
    updateReligionForYear(currentYear);
    updateTradeRoutesForYear(currentYear);
    updateLanguageForYear(currentYear);
  }
